...
final class FriendCell: UITableViewCell {
    ...
    private func addConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            friendAvatar.leftAnchor.constraint(equalTo: contentView.leftAnchor, constant: 15),
            ...
            friendName.leftAnchor.constraint(equalTo: friendAvatar.rightAnchor, constant: 40),
