...
final class GroupsViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        // Передаём в функцию getGroups замыкание, которое в самой ф-и обозначим как @escaping, чтобы после выполнения ф-и сюда вернулся массив, который мы сможем положить в model.
