...
final class PhotosViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        // Передаём в функцию getPhotos замыкание, которое в самой функции обозначим как @escaping, чтобы после выполнения функциии сюда вернулся массив, который мы сможем положить в model.
